...
- Make levels more "interactive" - Wally
	...
	something similar)
	- Russlan: I think we should leave this for after Stardance, but we could add the wrench item, alongside mechanics that regenerate dashes, double jumps, etc
...
- Russlan: The two above about gravswitch are good, but let's do it after Stardance
