...
func destroy_spikes() -> void:
	tilemap.set_cell(Vector2i(-23, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-22, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-21, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-20, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-19, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-18, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-17, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-16, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-15, -15), 0, Vector2i(9, 0))
	tilemap.set_cell(Vector2i(-14, -15), 0, Vector2i(9, 0))
